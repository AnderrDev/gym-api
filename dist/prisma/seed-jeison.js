...
async function main() {
    console.log('🌱 Creating Jeison Aranguren user and routine...');
    const hashedPassword = await bcrypt.hash('Jeison123', 10);
    const user = await prisma.user.upsert({
        where: { email: 'jeison.aranguren@gmail.com' },
        update: {},
        create: {
            email: 'jeison.aranguren@gmail.com',
            password: hashedPassword,
            name: 'Jeison Aranguren',
            age: 26,
            weight: 75,
            height: 172,
            goal: 'recomposition',
    ...
    console.log('\n🎉 Jeison Aranguren user and routine created successfully!');
    console.log(`Email: jeison.aranguren@gmail.com`);
    console.log(`Password: Jeison123`);
...
//# sourceMappingURL=seed-jeison.js.map