...
async function main() {
    console.log('🌱 Creating Vevita Iglesias user and routine...');
    const hashedPassword = await bcrypt.hash('Vevita123', 10);
    const user = await prisma.user.upsert({
        where: { email: 'vevita.iglesias@gmail.com' },
        update: {},
        create: {
            email: 'vevita.iglesias@gmail.com',
            password: hashedPassword,
            name: 'Vevita Iglesias',
            age: 25,
            weight: 80,
            height: 175,
            goal: 'gain_muscle',
    ...
    console.log('\n🎉 Vevita Iglesias user and routine created successfully!');
    console.log(`Email: vevita.iglesias@gmail.com`);
    console.log(`Password: Vevita123`);
}
main()
    .catch((e) => {
    console.error(e);
...
//# sourceMappingURL=seed-vevita.js.map